...
# Simple test lines
"code freaks out when i add test lines, at this point idk what i should be testing for, if the code runs perfectly fine as of now"




#note
"code freaks out when i put it in folder"
"update am not sure if it has been fixed"
